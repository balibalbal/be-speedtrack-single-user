...
const { Traccar } = require('../models');

const traccarController = {
  // Get all Device
  getAllTraccar: async (req, res) => {
    try {
      const users = await Traccar.getAllTraccar();
      res.json({
        success: true,
        data: users
      });
...
module.exports = traccarController;